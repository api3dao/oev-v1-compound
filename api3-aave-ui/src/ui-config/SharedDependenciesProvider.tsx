...
export const SharedDependenciesProvider: React.FC = ({ children }: any) => {
  ...
  // const governanceChainId = isGovernanceFork
  //   ? currentMarketData?.chainId
  //   : governanceConfig.chainId;
  // const stakingChainId = isStakeFork
  //   ? currentMarketData?.chainId
  //   : stakeConfig.chainId;
  ...
  const stakeProvider = isStakeFork
    ? currentProvider
