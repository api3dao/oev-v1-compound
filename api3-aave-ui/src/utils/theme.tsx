  ...
  return {
    components: {
      ...
      MuiAlert: {
        ...
        defaultProps: {
          iconMapping: {
            error: <SvgIcon color="error">{/* <ExclamationIcon /> */}</SvgIcon>,
            info: (
              <SvgIcon color="info">{/* <InformationCircleIcon /> */}</SvgIcon>
            ),
            success: (
              <SvgIcon color="success">{/* <CheckCircleIcon /> */}</SvgIcon>
            ),
            warning: (
