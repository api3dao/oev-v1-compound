...
export const StakeRewardClaimRestakeModalContent = ({
  ...
  const maxAmountToClaim = normalize(
    stakeUserResult?.[stakeAssetName as StakingType].userIncentivesToClaim ||
      "0",
    18,
  );
  ...
  const handleBlocked = () => {
    switch (blockingError) {
      case ErrorType.NOT_ENOUGH_BALANCE:
        return <div>No rewards to claim</div>;
      default:
        return null;
    }
  };
  ...
  return (
    <>
      <TxModalTitle title="Restake PZM rewards" />
      ...
      <AssetInput
        ...
        balanceText={<div>Amount claimable</div>}
      />
