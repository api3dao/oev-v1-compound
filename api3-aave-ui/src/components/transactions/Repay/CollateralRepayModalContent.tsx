...
import { ListSlippageButton } from "src/components/transactions/FlowCommons/SlippageList";
  ...
  const BlockingError: React.FC = () => {
    switch (blockingError) {
      case ErrorType.NOT_ENOUGH_COLLATERAL_TO_REPAY_WITH:
        return (
          <div>Not enough collateral to repay this amount of debt with</div>
        );
  ...
  return (
    <>
      <AssetInput
        ...
        maxValue={debt}
        inputTitle={<div>Expected amount to repay</div>}
        balanceText={<div>Borrow balance</div>}
      />
      <Box
        sx={{
          padding: "18px",
      ...
      <AssetInput
        ...
        onChange={handleRepayAmountChange}
        inputTitle={<div>Collateral to repay with</div>}
        balanceText={<div>Borrow balance</div>}
      ...
      >
        ...
        />
        <DetailsNumberLineWithSub
          description={<div>Borrow balance after repay</div>}
        ...
        />
        <DetailsNumberLineWithSub
          description={<div>Collateral balance after repay</div>}
